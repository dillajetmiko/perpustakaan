...
@section('page_title', 'Perpustakaan | Detail Peminjaman')
...
<div class="card">
    ...
    <div class="card-body">
        <div class="card">
            <div class="card-header">
            <h3 class="card-title">Tabel Detail Peminjaman</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href='/detailpeminjaman/editDetailpeminjaman/{{ $data->id_peminjaman }}&{{ $data->kode_buku}}'>
                        <button> edit </button>
                        </a>
                        <a href='/detailpeminjaman/hapus/{{ $data->id_peminjaman }}&{{ $data->kode_buku}}'>
                        <button> hapus </button> 
                        </a>
                        </td>
    ...
    <div class="card-footer">
        <a href="/detailpeminjaman/tambahDetailpeminjaman/{{ $pinjam->id_peminjaman }}">
        <i class="fas fa-plus"></i><b> Tambah detail peminjaman<b>
        </a>
    </div>
    @endforeach
    <!-- /.card-footer-->
